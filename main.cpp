...
int main(){
    cout<<"For printing enter 1 and press Enter. \nFor customizing your personal snowman, enter 5 and press ENTER. \nFor getting a snowman by ID press whatever you want (On the keyboard (DUH !!!)) and press ENTER. \n";
    string input; 
    cin>>input;
...
void printByID(){
    system("clear");
    string info ="Please enter 8 digit number where each digit is bigger or equal to 1 and lower or equal to 4 .";
    cout<<info<<endl;
...
void customize(){
    ...
    cout<<charles<<"Hello,\nmy name is Charles,\nIm your assistant here to build\nyour own unique (not really !) snoman,\nwhats your name ?\n";
    string name;
    cin>>name;
    system("clear");
    usleep(100000);
    ...
    usleep(1000000);
    system("clear");
    cout<<charles<<"Now "<<name<<",\nLets start with the customization.....\nJust wait a second I need to find my glasses.\n.....\n";
    usleep(7000000);
    system("clear");
    charles= snowman(11221111)+"___________\n";
    cout<<charles<<"Finally, I found them !\nWow, now I can see !\nI really shouldnt drink that much.\nNow, to work.....\n";
    usleep(7000000);
    system("clear");
    string message;
    message="Please choose a hat,\nPress:\n________________\n1 for that straw hat: \n _===_\n________________\n2 for a Mexican hat: \n ___ \n.....\n________________\n3 for a Fez:\n  _  \n /_\\ \n________________\n4 for a Russian hat:\n ___ \n(_*_)\n_________________\n";
    ...
    system("clear");
    charles= snowman(11221111)+"___________\n";
    message="Please choose a torso for your snowman,\nPress:\n________________\n1 for a buttons torso:\n      ( : )\n________________\n2 for a vest torso:\n      (] [)\n________________\n3 for an inward arms:\n      (> <)\n________________\n4 for no torso:\n\n_________________\n";
    cout<<charles<<"Ok, now step 7 :\n"<<message;
    int t ;
    t=readAndCheck(message);
    system("clear");
    charles= snowman(11221111)+"___________\n";
    message="Please choose a base for your snowman,\nPress:\n________________\n1 for a buttons base:\n      ( : )\n________________\n2 for a feet base:\n      (\" \")\n________________\n3 for a flat base:\n      (___)\n________________\n4 for no base:\n\n_________________\n";
    cout<<charles<<"Ok, now step 8 :\n"<<message;
    int b ;
    b=readAndCheck(message);
    system("clear");
    charles= snowman(11221111)+"___________\n";
    int HNLRXYTB=b+t*10+y*100+x*1000+r*10000+l*100000+n*1000000+h*10000000;
    string result =snowman(HNLRXYTB);
    cout<<charles<<"Ok my dear "<<name<<",\nI think we're done here.\nNow I'll take off my glasses and you'll get your such wanted personal snowman.\n";
...
void printSnowman(){
    cout<<"For printing it cool enter 1 and press Enter. \nFor the regular list printing enter whatever you want (On the keyboard (DUH !!!)) and press ENTER. \n";
    string input; 
    cin>>input;
    input=nospaces(input);
    if(input=="1"){
...
int readAndCheck(string message){
    ...
    while(output<1||output>4){
        ...
        usleep(1000000);
        system("clear");
        cout<<charles<<"Im not sure I gave you that opption !\nTry one more time ."<<message;
        for(;;){
            if(cin >> output)
                break;
            cin.clear();
...
int readAndCheckHNLRXYTB(string message){
    ...
    int output ;
        ...
        while(!(output>minimalBorderOfLegitDna&&output<maximalBorderOfLegitDna&&isBase3(output))){
            system("clear");
